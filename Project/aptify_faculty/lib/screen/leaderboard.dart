...
class Leaderboard extends StatelessWidget {
          ...
          SafeArea(
            child: Column(
              children: [
                ...
                // **Top 3 Players with White Font Color**
                Row(
  ...
  // **Top 3 Players Widget with White Font**
      ...
      children: [
        ...
        Text(
          ...
          style: const TextStyle(
            fontSize: 16,
            fontWeight: FontWeight.bold,
            color: Colors.white,    // White color for rank
          ),
        ),
        Text(
          score.toString(),
          style: const TextStyle(
            fontSize: 14,
            color: Colors.white,    // White color for score
          ),
        ),
      ],
    );
